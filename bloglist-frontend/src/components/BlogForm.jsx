...
const BlogForm = ({ createBlog, setNotification }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await createBlog({ title: title, author: author, url: url, year: Number(year) })
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <p>year: <input data-testid='year' type="text" value={year} onChange={({ target }) => setYear(target.value)} placeholder='year'></input></p>
